    ...
    <section className="page-container flex gap-6 py-16 font-dm-sans">
      <aside className="min-w-fit basis-[18rem]">
        <SearchInput
          ...
          value={query.search}
          onSearch={(s) => {
            debounceSingleQuery(2000, "search", s || undefined, true)
          }}
        ...
        <MultiSelectFilter
          ...
          isLoading={isDebounceLoading}
          onUpdate={(d) => {
            debounceSingleQuery(2000, "travel_experiences", d, true)
          }}
        ...
        <MultiSelectFilter
          ...
          isLoading={isDebounceLoading}
          onUpdate={(d) => {
            debounceSingleQuery(2000, "regions", d, true)
          }}
        ...
        <MultiSelectFilter
          ...
          isLoading={isDebounceLoading}
          onUpdate={(d) => {
            debounceSingleQuery(2000, "durations", d, true)
          }}
        ...
        <MultiSelectFilter
          ...
          isLoading={isDebounceLoading}
          onUpdate={(d) => {
            debounceSingleQuery(2000, "transportation_types", d, true)
          }}
      ...
      <section className="grow">
        ...
        <div className="flex justify-center pt-14">
          {count > 0 ? (
            <Button
              variant={"secondary"}
              className="ring-light-gray h-auto gap-3 rounded-3xl bg-transparent px-10 py-3 text-base font-medium ring-[1px]"
              onClick={() => {
                setPage((p) => p + 1, true)
              }}
